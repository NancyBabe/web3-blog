       ...
       const handleSubmit = async (e)=>{
         ...
         try {
                  if (imgfile == null) {
                           ...
                           await addDoc(collection(db, 'BlockBlogPost'), {
                                    User: {
    ...
    <div className='mt-[15vh] flex items-center justify-center'>
         <div className='block p-6 rounded-lg shadow-2xl bg-white w-[100vh]'>
                  ...
                  <div className='form-group mb-6'>
                           ...
                           <input className='m-4' type="file" accept='image/*' onChange= {handleChnage} />

                           <button className='w-full px-6 py-2.5 bg-blue-600 text-white font-medium text-xs leading-tight 
                           uppercase rounded shadow-md hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-800
                           active:shadow-lg transition duration-150 ease-in-out' onClick={handleSubmit} >Post</button>
